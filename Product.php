    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <img class="img-responsive" alt="Brand" src="img/logo1.0.jfif"  style="width: 70px;margin: 0px;">
         	</a>
        </div>
          ...
          <ul class="nav navbar-nav navbar-right">
              <?php
                  if(isset($_SESSION['user']))
                    {
                      echo'
                    <li><a href="cart.php" class="btn btn-md">Cart</span></a></li>
                    <li><a href="destroy.php" class="btn btn-md"> LogOut</span></a></li>
                         ';
                    }
               ?>
          </ul>
    ...
    echo '<div class="container-fluid" id="books">
        <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:rgb(96,0,0);text-transform:uppercase;margin-bottom:0px;"> '. $category .' STORE </h2>
           </div>
        </div>      
        <div class="container fluid">
             <div class="row">
